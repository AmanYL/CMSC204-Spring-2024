...
public class MorseCodeConverterTestPublic {
	...
	public void testConvertMorseStringToEnglishString() {	
		...
		//Below are the tests I implemented in addition to the original ones that were provided.
		String converted01 = MorseCodeConverter.convertToEnglish("- --- -.-- --- - .- / --- .-- -. ... / .-.. . -..- ..- ... / - .... .- - / .. ... / .-- .- -.-- / - .... . -.-- / .- .-. . / ... --- / .-. . .-.. .. .- -... .-.. .");
		assertEquals("toyota owns lexus that is way they are so reliable", converted01);
		
		String converted02 = MorseCodeConverter.convertToEnglish("- .... . .-. . / .. ... / -. --- / - --- -- --- .-. .-. --- .-- / -.. --- / .. - / - --- -.. .- -.--");
		assertEquals("there is no tomorrow do it today", converted02);
	}
	@Test
	public void testConvertMorseFileToEnglishString() {	
		...
		*/
		...
		/*Below are the tests I implemented in addition to the original ones that were provided.
		 * 
		 *Make sure RimacNevera.txt is in the src directory for this 
		  test to pass
		*/
		File meFile = new File("src/RimacNevera.txt"); 
		try {
			assertEquals("the rimac nevera is the fastest electric production car", MorseCodeConverter.convertToEnglish(meFile));
		} catch (FileNotFoundException e) {
			assertTrue("An unwanted exception was caught", false);
		}
	}
