...
public class MyQueueTest {
	...
	public void testEnqueueStudent() {
		try {
			...
			assertEquals(true, doubleQ.enqueue(t));
	...
	public void testToStringStudent() throws QueueOverflowException {
		assertEquals("12.031.017.0", doubleQ.toString());
		doubleQ.enqueue(t);
		assertEquals("12.031.017.03.0", doubleQ.toString());
		doubleQ.enqueue(y);
		assertEquals("12.031.017.03.080.0", doubleQ.toString());
	}
